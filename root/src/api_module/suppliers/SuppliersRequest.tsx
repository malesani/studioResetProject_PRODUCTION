...
export async function delete_supplierByUid(
  { supplier_uid }: { supplier_uid: string }
): Promise<DataResponse<APISupplier>> {
  const response = await requestFunction(
    '/suppliers/api/suppliers.php',
  ...
  // L'API di delete non ritorna un payload "data"
  return { response, data: undefined };
}

// Alias più corto, opzionale
export const delete_supplier = delete_supplierByUid;
